<template>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <defs>
      <symbol viewBox="0 0 55 66" id="useIcon">
        <g>
	...
	C53.487,56.748,52.407,63,44.696,63H10.569c-7.71,0-9.308-5.477-5.688-13.965c1.851-4.341,6.239-10.662,10.16-13.948"/>
          <path fill-rule="evenodd" clip-rule="evenodd" fill="none" stroke="#fda43a" stroke-width="3px"
                d="M27.116,3c10.566,0,19.132,8.568,19.132,19.138
	c0,10.57-8.565,19.138-19.132,19.138S7.984,32.708,7.984,22.138C7.984,11.568,16.549,3,27.116,3z"/>
        </g>
      </symbol>

      <symbol viewBox="0 0 55 66" id="passwrodIcon">
        <g>
          <path fill-rule="evenodd" clip-rule="evenodd" fill="none" stroke="#fda43a" stroke-width="3px"
                d="M7,25.734h42c2.209,0,4,1.791,4,4V59c0,2.209-1.791,4-4,4H7
        c-2.209,0-4-1.791-4-4V29.734C3,27.525,4.791,25.734,7,25.734z"/>

          <path xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" fill="none" stroke="#fda43a"
                stroke-width="3px"
      ...
      <symbol viewBox="0 0 55 66" id="rePasswrodIcon">
        <g>
          <path fill-rule="evenodd" clip-rule="evenodd" fill="none" stroke="#fda43a" stroke-width="3px"
                d="M7,25.734h42c2.209,0,4,1.791,4,4V59c0,2.209-1.791,4-4,4H7
        c-2.209,0-4-1.791-4-4V29.734C3,27.525,4.791,25.734,7,25.734z"/>
        ...
        s-1.5-0.671-1.5-1.5v-8C27.25,40.671,27.921,40,28.75,40z"/>
          <path fill-rule="evenodd" clip-rule="evenodd" fill="none" stroke="#fda43a" stroke-width="3px"
                d="M43.5,45c4.694,0,8.5,3.806,8.5,8.5S48.194,62,43.5,62
        S35,58.194,35,53.5S38.806,45,43.5,45z"/>
          <path fill-rule="evenodd" clip-rule="evenodd" fill="none" stroke="#fda43a" stroke-width="3px"
                d="M39.171,52.086l4.243,4.243L42,57.743L37.757,53.5L39.171,52.086z"/>
          <path fill-rule="evenodd" clip-rule="evenodd" fill="none" stroke="#fda43a" stroke-width="3px"
                d="M49.011,52.011l-6,6l-2-2l6.001-6.001L49.011,52.011z"/>
        </g>
      </symbol>
	...
	c0,10.57-8.565,19.138-19.132,19.138S7.984,32.708,7.984,22.138C7.984,11.568,16.549,3,27.116,3z"/>
      ...
      <symbol viewBox="0 0 49 60 " id="mobileIcon">
        <g>
